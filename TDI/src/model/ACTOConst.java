...
public final class ACTOConst {
	...
	public static final int SVC_FULL_POSE = 151; // reserved // ask pose update of all TUIOs					// format: CMD
	...
	public static final int SVC_GET_EXT = 162; //reserved // ask ext update of specific TUIO					// format: CMD, ID
	...
	public static final int SVC_GET_PLSIZE = 165; //reserved // ask resolution of playground					// format: CMD
	...
	public static final int SVC_SET_EXT = 182; //reserved // set/send ext state of specific TUIO					// format: CMD, ID, ???
	...
	public static final byte WI_FULL_STATE = 50; //reserved // ask full update of all TUIOs					// format: CMD
	public static final byte WI_FULL_POSE = 51; // reserved // ask pose update of all TUIOs					// format: CMD
	public static final byte WI_FULL_EXT = 52; // reserved // ask ext update of all TUIOs						// format: CMD
	public static final byte WI_FULL_TRANS = 53; // reserved // ask only translation update of all TUIOs		// format: CMD
	public static final byte WI_FULL_ROT = 54; // reserved // ask only rotation update of all TUIOs			// format: CMD
	
	public static final byte WI_GET_STATE = 60; //reserved // ask update of specific TUIO						// format: CMD, ID
	public static final byte WI_GET_POSE = 61; //reserved // ask pose update of specific TUIO 					// format: CMD, ID
	public static final byte WI_GET_EXT = 62; //reserved // ask ext update of specific TUIO					// format: CMD, ID
	...
	//also answer to GET messages
	public static final byte WI_SET_STATE = 80; //reserved // set/send state of specific TUIO						// format: CMD, ID, float[3], float[4], ???
	public static final byte WI_SET_POSE = 81; //reserved // set/send pose of specific TUIO						// format: CMD, ID, float[3], float[4]
	public static final byte WI_SET_EXT = 82; //reserved // set/send ext state of specific TUIO					// format: CMD, ID, ???
	...
	public static final byte WI_SET_PLSIZE = 85; //reserved // set/send resolution of playground, equivalent String "U"	// format: CMD, int[3]
	
	//TODO: convert from byte to int and back for bandwidth efficiency if necessary?
	...
	public static final byte USB_MOTOR_1 = 50;	// analog unit on extension			//format: CMD, ID, speed(int), SEP
	...
	public static final byte USB_DATA_BYTE = 60;	// send byte data to TUIO		//format: CMD, ID, dataID(byte), data(byte), SEP
	public static final byte USB_DATA_CHAR = 61;	// send char data to TUIO		//format: CMD, ID, dataID(byte), data(char), SEP
	public static final byte USB_DATA_INT = 62;		// send integer data to TUIO	//format: CMD, ID, dataID(byte), data(int), SEP
	public static final byte USB_DATA_FLOAT = 63;	// send float data to TUIO		//format: CMD, ID, dataID(byte), data(float), SEP
	
	//TODO:  USB_DATA also as getter, and setter
	//TODO: use only one digUnit / anaUnit aber daf�r zus�tzliche IDbyte wie bei data? verst�ndlicher?
	
//	public static final byte USB_DI_UNIT_0 = 0;		// digital unit on extension	//format: set: CMD, ID, data(byte), SEP	, get:CMD, ID, SEP
...
//	public static final byte USB_DI_UNIT_10 = 10;	// digital unit on extension
//	public static final byte USB_DI_UNIT_11 = 11;	// digital unit on extension
//	public static final byte USB_DI_UNIT_12 = 12;	// digital unit on extension
//	public static final byte USB_DI_UNIT_13 = 13;	// digital unit on extension
//	public static final byte USB_DI_UNIT_14 = 14;	// digital unit on extension
//	public static final byte USB_DI_UNIT_15 = 15;	// digital unit on extension
//	public static final byte USB_DI_UNIT_16 = 16;	// digital unit on extension
//	public static final byte USB_DI_UNIT_17 = 17;	// digital unit on extension
//	public static final byte USB_DI_UNIT_18 = 18;	// digital unit on extension
//	public static final byte USB_DI_UNIT_19 = 19;	// digital unit on extension
//	
//	public static final byte USB_AN_UNIT_0 = 20;	// analog unit on extension		//format: set: CMD, ID, data(int), SEP	, get:CMD, ID, SEP
