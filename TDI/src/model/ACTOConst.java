...
public final class ACTOConst {
	...
	// public static final int SVC_FULL_STATE = 150; //reserved // ask full
	// update of all TUIOs // format: CMD
	public static final int SVC_ALL_POSE = 151; // reserved // ask pose update
												// of all TUIOs // format: CMD
	// public static final int SVC_FULL_EXT = 152; //reserved // ask ext update
	// of all TUIOs // format: CMD
	// public static final int SVC_FULL_TRANS = 153; //reserved // ask only
	// translation update of all TUIOs // format: CMD
	// public static final int SVC_FULL_ROT = 154; //reserved // ask only
	// rotation update of all TUIOs // format: CMD
	...
	public static final int SVC_GET_PLSIZE = 165; // ask resolution of
													// playground // format: CMD
	...
	// public static final byte WI_FULL_STATE = 50; //TODO: remove? // ask full
	// update of all TUIOs // format: CMD
	public static final byte WI_ALL_POSE = 51; // TODO: remove? // ask pose
												// update of all TUIOs //
												// format: CMD
	// public static final byte WI_FULL_EXT = 52; //TODO: remove? // ask ext
	// update of all TUIOs // format: CMD
	// public static final byte WI_FULL_TRANS = 53; //TODO: remove? // ask only
	// translation update of all TUIOs // format: CMD
	// public static final byte WI_FULL_ROT = 54; //TODO: remove? // ask only
	// rotation update of all TUIOs // format: CMD

	// public static final byte WI_GET_STATE = 60; //TODO: remove? // ask update
	// of specific TUIO // format: CMD, ID
	...
	// also answer to GET messages
	// public static final byte WI_SET_STATE = 80; //TODO: remove? // set/send
	// state of specific TUIO // format: CMD, ID, float[3], float[4], ???
	...
	public static final byte WI_SET_PLSIZE = 85; // set/send resolution of
													// playground, equivalent
													// String "U" // format:
													// CMD, int[3]

	// TODO: convert states from byte to int and back for bandwidth efficiency
	// if necessary?
	...
	public static final byte USB_MOTOR = 50; // motor unit on extension
												// //format: CMD, ID,
												// direction(byte), speed(byte),
												// SEP
	public static final byte USB_MOTOR_MS = 51; // motor unit on extension
												// //format: CMD, ID,
												// direction(byte), speed(byte),
												// time_ms(int), SEP

	public static final byte USB_GET_DI_UNIT = 60; // get state of digital unit
													// on ext //format: CMD, ID,
													// dataID(byte), SEP
	public static final byte USB_SET_DI_UNIT = 80; // set state of digital unit
													// on ext //format: CMD, ID,
													// dataID(byte), data(byte),
													// SEP
	public static final byte USB_SET_PWM_UNIT = 82; // answer of analog unit
													// state on ext //format:
													// CMD, ID, dataID(byte),
													// data(int), SEP

	public static final byte USB_GET_AN_UNIT = 61; // get state of analog unit
													// on ext //format: CMD, ID,
													// dataID(byte), SEP
	public static final byte USB_SET_AN_UNIT = 81; // set state of analog unit
													// on ext //format: CMD, ID,
													// dataID(byte), data(int),
													// SEP

	public static final byte USB_GET_BYTE = 66; // get byte data //format: CMD,
												// ID, dataID(byte), SEP
	public static final byte USB_GET_CHAR = 67; // get char data //format: CMD,
												// ID, dataID(byte), SEP
	public static final byte USB_GET_INT = 68; // get int data //format: CMD,
												// ID, dataID(byte), SEP
	public static final byte USB_GET_FLOAT = 69; // get float data //format:
													// CMD, ID, dataID(byte),
													// SEP

	public static final byte USB_SET_BYTE = 86; // send byte data //format: CMD,
												// ID, dataID(byte), data(byte),
												// SEP
	public static final byte USB_SET_CHAR = 87; // send char data //format: CMD,
												// ID, dataID(byte),
												// data(char16), SEP
	public static final byte USB_SET_INT = 88; // send integer data //format:
												// CMD, ID, dataID(byte),
												// data(int32), SEP
	public static final byte USB_SET_FLOAT = 89; // send float data //format:
													// CMD, ID, dataID(byte),
													// data(float32), SEP
