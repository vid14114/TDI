...
//	@Test
	...
	public void testPluginMethods() throws IOException{
		new BufferedWriter(new FileWriter(TDIDirectories.TDI_PREFERENCE, false)).close(); //Here I make sure the preference file is empty
